...
public class Storage {
    ...
    public static Map<String, Customer> loadAccounts() { //key : string, value : customer
    ...
    public static void loadTransactions(Map<String, Customer> customers) {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(file))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (customer != null) {
                    Transaction txn = Transaction.fromRecord(type, amount, resultingBalance, note, timestamp);
